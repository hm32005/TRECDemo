...
public class BatchSearchModBM25{

	private BatchSearchModBM25() {}
	...
	public static void main(String[] args) throws Exception {
		...
		if ("default".equals(simstring)) {
			...
			simfn = new BM25Similarity(0.2F, 0.5F);
		...
		while (true) {
			...
			writer.write(doBatchSearch(in, searcher, pair[0], query, simstring));
		}
		reader.close();
		writer.close();
	}
